    ...
    <div className="w-[300px] bg-white p-6 shadow-xl border border-gray-100 rounded-lg">
      ...
      <div className="space grid grid-cols-1 gap-4 ">
        ...
        <Link href="/services/realEstate" className="block text-sm hover:underline">
          ...
          <img src='/Real Estate.webp' alt="real-estate" className="w-6"  height="fit"
          width="fit"></img>
          </span>Real Estate</div>
        </Link>
        <Link href="/services/renewableEnergy" className="block text-sm hover:underline">
          <div className="mr-2 flex gap-2"><span ><img src="/Renewable Energy.webp" alt="renewable-energy" className="w-6"  height="fit"
          width="fit"></img></span>Renewable Energy </div>
        </Link>
        <Link href="/services/businessSetup" className="block text-sm hover:underline">
          <div className="mr-2 flex gap-2"><span className="w-6"><img  height="fit"
          width="fit" src="/Instant Business Loan.webp" alt="businees-loan"></img></span>Business Setup</div>
        </Link>
        <Link href="/services/tourismAndHospitality" className="block text-sm hover:underline">
          <div className="mr-2 flex gap-2"><span className="w-6"><img   height="fit"
          width="fit" src="/Tourism & Hospitality.webp" alt="tourism"></img></span>Tourism and Hospitality</div>
        </Link>
        <Link href="/services/infrastructure" className="block text-sm hover:underline">
          <div className="mr-2 flex gap-2"><span className="w-6"><img  height="fit"
          width="fit" src="/Infrastructure.webp" alt="infrastructure"></img></span>Infrastructure</div>
        </Link>
        <Link href="/services/healthcare" className="block text-sm hover:underline">
          <div className="mr-2 flex gap-2"><span className="w-6"><img  height="fit"
          width="fit" src="/Health Care.webp" alt="healtcare"></img></span>Healtcare</div>
        </Link>
        <Link href="/services/education" className="block text-sm hover:underline">
          <div className="mr-2 flex gap-2"><span className="w-6"><img  height="fit"
          width="fit" src="/Education.png" alt="education"></img></span>Education</div>
        </Link>
        <Link href="/services/stockMarket" className="block text-sm hover:underline">
          <div className="mr-2 flex gap-2"><span className="w-6"><img  height="fit"
          width="fit" src="/Stock Market.webp" alt="stock-market"></img></span>Stock Market</div>
        </Link>
     </div>
  </div>
  );
