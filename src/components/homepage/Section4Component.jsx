...
const Section4Component = ({icon,heading}) => {
  return (
    <motion.div
      className=" h-[15rem] sm:h-auto   border border-gray-300 bg-white rounded-lg flex flex-col sm:gap-2 sm:p-8 md:gap-  gap-6 p-4 md:p-5 lg:p-4   2xl:p-6 cursor-pointer z-50 justify-center items-center sm:items-start"
